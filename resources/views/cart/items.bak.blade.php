...
<main style="margin-top:0px !important">
    ...
    <div class='row'> 
        ...
        <div class="col-xs-2 col-md-3 col-sm-3 column productbox">
            <a href="#"><img src="{{$item->options->image}}" class="img-responsive" style="width:50%!important;height:50%!important"></a><br><br>
